...
define(["app"], function(app) {
	app.controller("billHistoryCtrl", ["$scope","httpService", "serviceUrl", function ($scope, httpService, serviceUrl) {
        ...
        $scope.callDataService = function(date) {
            ...
            httpService.getServiceHandler(serviceUrl.mockdata.billHistory.allUserDetails).then(
                ...
                function (response) {
                    ...
                    httpService.getServiceHandler(serviceUrl.mockdata.billHistory.userDetails).then(
                        function (response) {
                            console.log(response);
